...
public class Main {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        // 4) Execute a statement
            ...
            String sql1 = "insert into city (Name, CountryCode, District, Population) " +
                    "values('Aalborg', 'DNK', 'Aalborg', 10000)";

        String sql2 = "insert into city (Name, CountryCode, District, Population) " +
                "values('Hilleroed', 'DNK', 'Hilleroed', 12000)";
